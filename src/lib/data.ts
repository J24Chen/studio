...
export const userTierLists: UserTierList[] = [
  {
    class: 'Heavy Slasher',
    items: [
      { item: "Berserker's Greataxe", tier: 'S' },
      { item: 'Ruby Ring', tier: 'A' },
      { item: 'Swift Boots', tier: 'A' },
      { item: 'Moon Glaive', tier: 'B' },
      { item: 'Leather Armor', tier: 'C' },
      { item: 'Cursed Idol', tier: 'D' },
    ],
  },
  {
    class: 'Spellcaster',
    items: [
      { item: 'Ancient Tome', tier: 'S' },
      { item: 'Sapphire Brooch', tier: 'S' },
      { item: "Mage's Circlet", tier: 'A' },
      { item: 'Swift Boots', tier: 'B' },
      { item: 'Cursed Idol', tier: 'C' },
      { item: 'Leather Armor', tier: 'F' },
    ],
  },
];
